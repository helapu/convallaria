defmodule ConvallariaWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ConvallariaWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/convallaria_web/templates",
      ...
      import ConvallariaWeb.Router.Helpers
      import ConvallariaWeb.ErrorHelpers
      import ConvallariaWeb.Gettext
    end
  end
